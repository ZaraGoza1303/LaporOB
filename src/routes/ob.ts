...
obRouter.post("/laporan/:laporan_id/histori", upload.array('foto_selesai'), (req, res) => obController.submitHistori(req, res));
obRouter.post("/laporan/:laporan_id/tolak", upload.array('foto_selesai'), (req, res) => obController.rejectLapor(req, res));
