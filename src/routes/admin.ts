...
adminRouter.post("/tugas/:tugas_id/approve", (req, res) => adminController.approveTugas(req, res));
...
adminRouter.post("/checklist-harian/:checklist_harian_id/approve", (req, res) => adminController.approveChecklist(req, res));
