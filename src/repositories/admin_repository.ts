...
import type { IAdminRepository, DailyChecklistObReport, PenugasanObWithDetails, StatsTugasResult, ObRankingRawData, TrenLaporanBulananRaw } from "./admin_repository.interface.js";
